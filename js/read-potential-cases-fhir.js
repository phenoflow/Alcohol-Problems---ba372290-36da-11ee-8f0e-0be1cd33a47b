...
(async () => {
  ...
  await fs.writeFile("alcohol-problems-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("alcohol-problems-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
